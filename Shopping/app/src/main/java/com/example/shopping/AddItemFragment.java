...
public class AddItemFragment extends Fragment {
    ...
    public ArrayList<ShoppingManager.Shopping> items;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                long id = shoppingDbHelper.insert(db, editTextItem.getText().toString());

                item = ShoppingManager.createElement(content);
    ...
    public interface OnAddItemFragmentInteractionListener {
        ...
        void OnAddItemFragmentInteraction(ShoppingManager.Shopping item);
    }
}
