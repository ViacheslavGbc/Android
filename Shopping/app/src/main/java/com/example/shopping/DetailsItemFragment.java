...
public class DetailsItemFragment extends Fragment
    ...
    public static ShoppingManager.Shopping item;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                shoppingDbHelper.delete(db, item.id);

                ShoppingManager.removeElement(item);
    ...
    public void onButtonPressed(ShoppingManager.Shopping item) {
        if (mListener != null) {
            mListener.onFragmentInteraction(item);
        }
    }

    public void updateView(ShoppingManager.Shopping item) {
    ...
    public void onListFragmentInteraction(ShoppingManager.Shopping item) {
        Log.d("Detail", " > onListFragmentInteraction" + item.content);
        this.item = item;
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteraction(ShoppingManager.Shopping item);
    }
}
